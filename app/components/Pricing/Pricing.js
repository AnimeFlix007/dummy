  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log({
        ...
        email,
        subject,
        text: JSON.stringify({ job, influencer, number, comments }),
      });
              ...
              <div className="content">
                <center>
                  <div>
                    ...
                    <p>
                      Schedule a live demo with one of our influence marketing
                      experts to see how Footprynt can help you reach your
                      business goals
                    </p>
                  </div>
                </center>
